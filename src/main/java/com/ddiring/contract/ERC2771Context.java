...
public class ERC2771Context extends Contract {
    ...
    @Deprecated
    protected ERC2771Context(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected ERC2771Context(String contractAddress, Web3j web3j,
    ...
    @Deprecated
    public static ERC2771Context load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new ERC2771Context(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ERC2771Context load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public static RemoteCall<ERC2771Context> deploy(Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
    ...
    public static RemoteCall<ERC2771Context> deploy(Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
