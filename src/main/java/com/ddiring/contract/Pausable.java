...
public class Pausable extends Contract {
    ...
    @Deprecated
    protected Pausable(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected Pausable(String contractAddress, Web3j web3j, TransactionManager transactionManager,
            BigInteger gasPrice, BigInteger gasLimit) {
    ...
    @Deprecated
    public static Pausable load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new Pausable(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static Pausable load(String contractAddress, Web3j web3j,
    ...
    public static RemoteCall<Pausable> deploy(Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
    ...
    public static RemoteCall<Pausable> deploy(Web3j web3j, TransactionManager transactionManager,
            ContractGasProvider contractGasProvider) {
